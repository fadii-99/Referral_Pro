    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('social_platform', models.CharField(blank=True, max_length=20, null=True)),
                ('referral_code', models.CharField(blank=True, editable=False, max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avg_rating', models.CharField(blank=True, max_length=10, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_seen', models.DateTimeField(blank=True, help_text='Last time the device was seen online', null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True, null=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='devices', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'indexes': [models.Index(fields=['user', 'token'], name='accounts_de_user_id_d185ef_idx'), models.Index(fields=['created_at'], name='accounts_de_created_5577e0_idx'), models.Index(fields=['user', 'is_online'], name='accounts_de_user_id_9e5b78_idx'), models.Index(fields=['last_seen'], name='accounts_de_last_se_b48553_idx')],
            },
        ),
        migrations.CreateModel(
