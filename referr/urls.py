...
from .views import CompaniesListView, SendReferralView, ListReferralView,ListCompanyReferralView, SendAppInvitationView
...
urlpatterns = [
    ...
    path("add_manually/", SendAppInvitationView.as_view(), name="list_company_referral"),
]
